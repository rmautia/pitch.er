...
def index():
    ...
    survey_piches = Pitch.get_pitches('survey')
    idea_piches = Pitch.get_pitches('idea')
    promotion_pitches = Pitch.get_pitches('promotion')


    return render_template('index.html',title = title, survey = survey_piches, idea = idea_piches, promotion = promotion_pitches)
...
@main.route('/pitches/survey_pitches')
def survey_pitches():

    pitches = Pitch.get_pitches('survey')

    return render_template("survey_pitches.html", pitches = pitches)
